  ...
  return (
    ...
    <div className="product-item-container">
        ...
        <div className="right-container">
            <h3 className='head1'>Flipkart SmartBuy Back Cover for OPPO Reno8 5G, OPPO Reno 8 5G, OPPO Reno8, OPPO Reno 8
              (Multicolor, Dual Protection, Silicon, Pack of: 1)</h3>
        <div className="rate">
